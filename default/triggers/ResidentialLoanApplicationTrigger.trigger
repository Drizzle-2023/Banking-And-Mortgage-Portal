trigger ResidentialLoanApplicationTrigger on ResidentialLoanApplication (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    if (trigger_control.Active__c) {
        if (Trigger.isBefore && trigger_control.Before__c) {
            ...
            if (Trigger.isInsert && trigger_control.Insert__c) {
                ResidentialLoanApplicationTriggerHandler.beforeInsert(Trigger.new);
            }
